...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>Agregar Nueva Decoración</title>
            ...
            <div class="row-fluid">
                ...
                <div id="content" class="span10">
                    <ul class="breadcrumb">
                        ...
                        <li><i class="icon-globe"></i><a href="events.php">&nbsp; Añadir Decoración</a></li>
                    </ul>
                    ...
                    if (isset($_POST['bts'])):
                        if ($_POST['name_decoration'] != null && $_POST['status'] != null) {
                            $stmt = $mysqli->prepare("INSERT INTO decorations(name_decoration,status,id_party) VALUES (?,?,?)");
                            $stmt->bind_param('sss', $name_decoration,$status,$salon);
                            $name_decoration = $_POST['name_decoration'];
                            $salon = $_POST['party'];
                            $status = $_POST['status'];

                            if ($stmt->execute()):
                                $mysqli->close();
                                echo "<script>location.href='decorations.php'</script>";
                                ?>
            <!-- <p></p>
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" class="form-horizontal">
                                ...
                                <div class="control-group col-sm-5 mar-top40">
                                    <label class="control-label" for="focusedInput">Nombre de la decoración:</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" id="focusedInput" type="text" 
                                               name="name_decoration" id="nm">
                                    </div>
                                </div>
