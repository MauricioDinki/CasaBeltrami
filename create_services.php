				...
				<li>
					...
					<i class="icon-angle-right"></i>
                       ...
                       <?php
                            include "config.php";
                if (isset($_POST['bts'])):
    if ($_POST['name_service'] != null && $_POST['service_description'] != null && $_POST['status'] != null ) {
        $stmt = $mysqli2->prepare("INSERT INTO services(name_service,service_description,status) VALUES (?,?,?)");
        $stmt->bind_param('sss', $name_service, $service_description, $status);
