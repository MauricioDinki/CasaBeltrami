					...
					<div class="box-content">
						<div class="masonry-gallery">
                                                    <?php
                                                        include "config.php";
                                                        error_reporting(E_ALL);
                                                        $res2 = $mysqli2->query("SELECT DISTINCT c.id_content,c.tittle,c.route,c.short_description,c.long_description FROM content_party_room AS cpr LEFT JOIN content AS c ON c.id_content = cpr.id_content  WHERE cpr.id_event ='" . $id_pr . "'");
                                                         $mysqli2->close();
