        ...
        <div class="collapse navbar-collapse navbar-centered" id="myNavbarMobile">
          <ul class="nav navbar-nav grey-text center">
                             <li class="dropdown">
                              ...
                              <li class="dropdown">
                                  <a href="events.php" class="dropdown-toggle MontserratL nineteen grey nav-links-sections small-caps">
                                      eventos
                                  </a>
                              </li>
                              <li class="dropdown">
        ...
        <div class="row padd-bottom-20 services-links-blocks services-web" style="margin-right: 0px;">
          <div class="col-md-2 col-xs-6 col-md-offset-3">
              ...
              <div class="out-border-icon">
                  ...
                  <br>
                    <img src="assets/img/icons/iconos-30.png" alt="" class="icon-service center-block" style="padding-bottom:10px; width: 55px; padding-top: 5px;">
          ...
          <div class="col-md-2 col-xs-6">
              ...
              <br>
                ...
                <h3 class="nineteen Montserrat grey text-center small-caps no-margin line-icons" style="margin-top: -10px;">mesa de <br>dulces y quesos </h3>
                <br>
              </div>
              </a>
          </div>
