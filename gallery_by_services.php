...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Galería Por Servicios</title>
					...
					<div class="box-content">
						<div class="masonry-gallery">
                                                    <?php
                                                        include "config.php";
                                                        error_reporting(E_ALL);
                                                        $res2 = $mysqli2->query("SELECT DISTINCT c.id_content,c.tittle,c.route,c.description FROM content_party_room AS cpr LEFT JOIN content AS c ON c.id_content = cpr.id_content  WHERE cpr.id_service ='" . $id_pr . "' LIMIT 3");
                                                         $mysqli2->close();
