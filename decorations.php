            ...
            <table id="example" class="display table table-bordered table-stripe" cellspacing="4"  style="margin-top: 50px">
                <thead >
                    <tr >
                        ...
                        <th style="text-align: center">Nombre de la decoración</th>
                ...
                <tbody>
                    <?php
                        $res = $mysqli2->query("SELECT * FROM decorations ");
                        $mysqli2->close();
                        while ($row = $res->fetch_assoc()):
                    ?>
                        <tr>
                            
                            <td style="text-align: center;"width="8%"><?php echo $row['name_decoration'];  ?></td>
